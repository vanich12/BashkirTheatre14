    ...
    public static class BuildMainNavigationExtensions
    {
        public static IHostBuilder BuildMainNavigation(this IHostBuilder builder)
        {
            builder.ConfigureServices(services =>
            {
                ...
                services.AddParameterNavigationService<QuizItemViewModel, NavigationStore, QuizModel>(); 
                services.AddParameterNavigationService<QuizViewModel, NavigationStore, QuizModel>();
